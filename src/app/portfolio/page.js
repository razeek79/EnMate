...
export default function UltimatePortfolioShowcase() {
  ...
  // 🔐 INTERACTIVE MODAL OPERATIONS ACTIONS - DECLARED AT COMPONENT ROOT LEVEL
  ...
  // Let root loading.js handle viewport transitions natively
        ...
        >
          ...
          <div className="w-full max-w-[1100px] flex flex-col items-center gap-6 relative" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-center space-y-1.5 max-w-[620px] px-2">
              <h2 className="text-base md:text-2xl font-bold font-anokha text-white tracking-wide uppercase">{activeLightboxProject.title}</h2>
