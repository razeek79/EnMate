...
export default function AgencyConnectPortal() {
  ...
  // Cleanly integrate hooks for your global root layout WholeCursor tracking
  useEffect(() => {
  ...
  const phoneUrl = "tel:+918075186078"; // 🔥 Triggers native device calling applications
      ...
      <div className="w-full max-w-[380px] bg-[#07040f]/90 border border-white/5 backdrop-blur-xl rounded-[2.5rem] p-6 md:p-8 text-center shadow-2xl relative z-10 space-y-7">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-xl font-bold font-anokha gradient-text tracking-wide uppercase">EnMate</h1>
            <p className="text-[10px] font-mono font-bold text-[var(--accent-soft)] tracking-widest uppercase">Premium Digital Marketing Agency</p>
          </div>
          <p className="text-xs text-neutral-400 font-light leading-relaxed max-w-[320px] mx-auto">
            Engineering high-performance web solutions, luxury brand layouts, and globally optimized conversion pipelines
          </p>
        </div>

        {/* INCREASED & BRIGHTENED SOCIAL ICONS TRACK */}
        ...
        {/* 🎯 PERFECT FLAT GRID TRACK - SURGICALLY MATCHED WIDTH & CENTERING */}
        <div className="w-full space-y-3 pt-1">
          ...
          {/* Button 3: Share your experience */}
          <a 
            href={reviewUrl}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a 
            ...
            className="custom-connect-link w-full h-[54px] px-5 bg-white/[0.03] border border-white/5 hover:bg-white/[0.06] hover:border-white/10 rounded-2xl flex items-center justify-between text-xs font-mono font-bold uppercase tracking-wider text-white transition-all duration-300 group"
          >
            {/* 🔥 FIXED: Bright phone icon layout replacing old envelope setups */}
            <div className="w-6 flex items-center justify-start text-white text-base shrink-0">
