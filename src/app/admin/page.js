    ...
    <div className="min-h-screen bg-[#05030a] text-[var(--text-main)] pt-32 pb-12 px-4 md:px-8 font-sans selection:bg-[var(--accent)] selection:text-white">
      <div className="w-full max-w-[1200px] mx-auto space-y-12 text-left">
        ...
        <div>
          ...
          <h1 className="text-3xl md:text-5xl font-bold font-anokha gradient-text tracking-tight uppercase">EnMate Core Operations</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          ...
          {/* Portfolio Module Card Link (Handled via default .btn transition animations for WholeCursor) */}
          ...
          {/* Blog Module Card Link (Handled via default .btn transition animations for WholeCursor) */}
