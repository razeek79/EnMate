      ...
      <div className="container max-w-[1100px] space-y-16 md:space-y-24">
        ...
        <header className="space-y-5 text-left">
          ...
          <div className="space-y-3 max-w-[850px]">
            ...
            <h1 className="text-2xl md:text-5xl font-bold font-anokha text-white tracking-tight leading-none">{service.title}</h1>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start text-left">
          <div className="lg:col-span-4">
            ...
            <h2 className="text-xl md:text-3xl font-bold font-anokha text-white leading-tight">Key Business Benefits</h2>
        ...
        <section className="space-y-8 text-left">
          <div className="max-w-[600px]">
            ...
            <h2 className="text-xl md:text-3xl font-bold font-anokha text-white">Our Tactical Process</h2>
          </div>
        ...
        <section className="space-y-6 text-left">
          <div>
            ...
            <h2 className="text-xl md:text-3xl font-bold font-anokha text-white">Related Case Studies</h2>
          </div>
        ...
        <section className="space-y-8 text-left">
          <div className="max-w-[550px]">
            ...
            <h2 className="text-xl md:text-3xl font-bold font-anokha text-white">Answers Shared with Partners</h2>
          </div>
        ...
        <section className="pt-4">
          <div className="p-6 md:p-12 bg-gradient-to-br from-[#07040f] via-[#cf0466]/5 to-[#07040f] border border-white/10 rounded-2xl text-center space-y-6 shadow-2xl relative overflow-hidden">
            <div className="relative z-10 space-y-4 max-w-[650px] mx-auto">
              ...
              <h2 className="text-xl md:text-3xl font-bold font-anokha text-white">Ready to Deploy This Specialty?</h2>
